...
#keeping only samples which will go into the analysis for ACR and excluding first week samples
Transplant_PS_ACR <- subset_samples(Transplant_PS, ACR_final_sample =="yes" & time_from_transplant>=8)
...
transplant_meta_final_ACR<-sample_data(Transplant_PS_ACR)
write.table(transplant_meta_final_ACR, file = "msq.master.map.transplant_ACR.txt", row.names = FALSE, sep ='\t', quote=F)

                    
Transplant_PS_ACR_relab =  subset_samples(Transplant_PS_relab, ACR_final_sample =="yes"  & time_from_transplant>=8)
...
beta_diversity_KW(Transplant_PS_ACR_all_relab, "sample_type", 
                  c("BKG", "Lower", "Upper"), c("darkgoldenrod1", "steelblue2", "purple2"), 
                  p_value="yes", output="beta_diversity_all_ACR")
### get p value for the individual comparsion 
beta_diversity_KW(Transplant_PS_ACR_all_relab, "sample_type", c("Lower", "BKG"), c("steelblue2", "darkgoldenrod1"), p_value="yes", output="beta_diversity_LB_ACR")
beta_diversity_KW(Transplant_PS_ACR_all_relab, "sample_type", c("Upper", "BKG"), c( "purple2", "darkgoldenrod1"), p_value="yes", output="beta_diversity_UB_ACR")
beta_diversity_KW(Transplant_PS_ACR_all_relab, "sample_type", c("Upper", "Lower"), c("steelblue2", "purple2"), p_value="yes", output="beta_diversity_UL_ACR")
