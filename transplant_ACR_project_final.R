...
transplant_meta_final_ACR<-transplant_meta_final %>% filter(ACR_final_sample =="yes")
write.table(transplant_meta_final_ACR, file = "msq.master.map.transplant_ACR.txt", row.names = FALSE, sep ='\t', quote=F)
...
##################Figure 2 A##################
read_count_KW(Total_ddPCR_ACR_2_4, "acr2_analysis_group24_rename", 
              c("Pre-ACR", "ACR"), c("lightgoldenrod", "lightseagreen"), 
              xlabel_size=14, ylabel_size=13, axis_title_size=15,
              p_value="yes", output="ddPCR_bronch_ACR_Grp_2_4_lightseagreen", ylabel="Bacterial concentration (log10 copies per uL)", count_variable="ddPCR_count")

read_count_KW(Transplant_PS_ACR_2_4, "acr2_analysis_group24_rename", 
              c("Pre-ACR", "ACR"), c("lightgoldenrod", "lightseagreen"), 
              xlabel_size=14, ylabel_size=13, axis_title_size=15,
              p_value="yes", output="read_count_bronch_ACR_Grp_2_4_lightseagreen")

##################Figure 2 B##################
alpha_diversity_KW(Transplant_PS_ACR_2_4, "acr2_analysis_group24_rename", 
                   c("Pre-ACR", "ACR"), c("lightgoldenrod", "lightseagreen"), 
                   xlabel_size=14, ylabel_size=13, axis_title_size=15,
                   p_value="yes", output="alpha_bronch_ACR_Grp_2_4_lightseagreen")

##################Figure 2 C##################
beta_diversity_KW(Transplant_PS_ACR_2_4_relab, "acr2_analysis_group24_rename", 
                  c("Pre-ACR", "ACR"), c("lightgoldenrod", "lightseagreen"), 
                  p_value="yes", output="beta_bronch_ACR_Grp_2_4_lightseagreen")
...
##############Secondary outcome################
setwd("C:/Users/kendr/OneDrive/Desktop/research_transplant/transplant_output/ACR/secondary_outcome") #set the directory to the raw file directory 

#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
Transplant_PS_ACR_A_B_C <-subset_samples(Transplant_PS_ACR_lower,treated_analysis_group %in% c("group A", "group B", "group C"))
Transplant_PS_ACR_A_B_C_relab <-subset_samples(Transplant_PS_ACR_lower_relab, treated_analysis_group %in% c("group A", "group B", "group C"))
Transplant_PS_ACR_A_B_C_prune <-subset_samples(Transplant_PS_ACR_lower_prune, treated_analysis_group %in% c("group A", "group B", "group C")) ##Pruned phyloseq
Transplant_PS_ACR_A_B_C_relab_prune <-subset_samples(Transplant_PS_ACR_lower_relab_prune, treated_analysis_group %in% c("group A", "group B", "group C")) ##Pruned phyloseq
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
#ddPCR read count
phyloseq_keep_ddPCR_ACR_A_B_C <-data.frame(sample_data(Transplant_PS_ACR_A_B_C)[,c("SampleID","treated_analysis_group")])
Total_ddPCR_ACR_A_B_C <- merge(Total_ddPCR, phyloseq_keep_ddPCR_ACR_A_B_C, by="SampleID") #keeping only the samples we care about (processed phyloseq)
##################Figure 1 A##################
read_count_KW(Total_ddPCR_ACR_A_B_C, "treated_analysis_group", 
              c("group A", "group B", "group C"), c("seagreen4", "navyblue", "orangered"), 
              xlabel_size=14, ylabel_size=13, axis_title_size=15,
              p_value="yes", output="ddPCR_bronch_ACR_Grp_A_B_C",
              ylabel="Bacterial concentration (log10 copies per uL)", count_variable="ddPCR_count")

read_count_KW(Transplant_PS_ACR_A_B_C, "treated_analysis_group", 
              c("group A", "group B", "group C"), c("seagreen4", "navyblue", "orangered"), 
              xlabel_size=14, ylabel_size=13, axis_title_size=15,
              p_value="yes", output="read_count_bronch_ACR_Grp_A_B_C")
##################Figure 1 B##################
alpha_diversity_KW(Transplant_PS_ACR_A_B_C, "treated_analysis_group", 
                   c("group A", "group B", "group C"), c("seagreen4", "navyblue", "orangered"), 
                   xlabel_size=14, ylabel_size=13, axis_title_size=15, 
                   p_value="yes",output="alpha_bronch_ACR_Grp_A_B_C")
##################Figure 1 C##################
beta_diversity_KW(Transplant_PS_ACR_A_B_C_relab, "treated_analysis_group", 
                  c("group A", "group B", "group C"), c("seagreen4", "navyblue", "orangered"), 
                  p_value="yes", p_value_location = "BR" , output="beta_bronch_ACR_Grp_A_B_C")
beta_diversity_KW(Transplant_PS_ACR_A_B_C_relab, "treated_analysis_group", 
                  c("group A", "group B"), c("seagreen4", "navyblue"), 
                  p_value="yes", p_value_location = "BR", output="beta_bronch_ACR_Grp_A_B")
beta_diversity_KW(Transplant_PS_ACR_A_B_C_relab, "treated_analysis_group", 
                  c("group A", "group C"), c("seagreen4", "orangered"), 
                  p_value="yes", p_value_location = "BR", output="beta_bronch_ACR_Grp_A_C")
beta_diversity_KW(Transplant_PS_ACR_A_B_C_relab, "treated_analysis_group", 
                  c("group B", "group C"), c("navyblue", "orangered"), 
                  p_value="yes", p_value_location = "BR", output="beta_bronch_ACR_Grp_B_C")

#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
Transplant_PS_ACR_A_B <-subset_samples(Transplant_PS_ACR_lower, treated_analysis_group %in% c("group A", "group B"))
Transplant_PS_ACR_A_B_relab <-subset_samples(Transplant_PS_ACR_lower_relab, treated_analysis_group %in% c("group A", "group B"))
Transplant_PS_ACR_A_B_prune <-subset_samples(Transplant_PS_ACR_lower_prune, treated_analysis_group %in% c("group A", "group B")) ##Pruned phyloseq
Transplant_PS_ACR_A_B_relab_prune <-subset_samples(Transplant_PS_ACR_lower_relab_prune, treated_analysis_group %in% c("group A", "group B")) ##Pruned phyloseq
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
##################Figure 1 D##################
Edger_phylo_KW(Transplant_PS_ACR_A_B_prune, 
               variable_to_compare="treated_analysis_group",
               outcome_to_compare=c("group A", "group B"),
               outcome_to_compare_color=c("seagreen4", "navyblue"),
               FDR_cut_off=0.2,number_display=25,
               legend_onplot="yes",
               output_name="Edger_bronch_ACR_Grp_A_B",
               decontam="Contam_list_NC_BKG_compare_Lower_and_Upper_ACR")

section_separator("ACR group 1 vs 3")
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
Transplant_PS_ACR_A_C <-subset_samples(Transplant_PS_ACR_lower, treated_analysis_group %in% c("group A", "group C"))
Transplant_PS_ACR_A_C_relab <-subset_samples(Transplant_PS_ACR_lower_relab, treated_analysis_group %in% c("group A", "group C"))
Transplant_PS_ACR_A_C_prune <-subset_samples(Transplant_PS_ACR_lower_prune, treated_analysis_group %in% c("group A", "group C")) ##Pruned phyloseq
Transplant_PS_ACR_A_C_relab_prune <-subset_samples(Transplant_PS_ACR_lower_relab_prune, treated_analysis_group %in% c("group A", "group C")) ##Pruned phyloseq
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
##################Figure 1 E##################
Edger_phylo_KW(Transplant_PS_ACR_A_C_prune, 
               variable_to_compare="treated_analysis_group",
               outcome_to_compare=c("group A", "group C"),
               outcome_to_compare_color=c("seagreen4", "orangered"),
               FDR_cut_off=0.2,number_display=25,
               legend_onplot="yes",
               output_name="Edger_bronch_ACR_Grp_A_C",
               decontam="Contam_list_NC_BKG_compare_Lower_and_Upper_ACR")

#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
Transplant_PS_ACR_B_D <-subset_samples(Transplant_PS_ACR_lower, treated_analysis_group %in% c("group B", "group D"))
Transplant_PS_ACR_B_D_relab <-subset_samples(Transplant_PS_ACR_lower_relab, treated_analysis_group %in% c("group B", "group D"))
Transplant_PS_ACR_B_D_prune <-subset_samples(Transplant_PS_ACR_lower_prune, treated_analysis_group %in% c("group B", "group D")) ##Pruned phyloseq
Transplant_PS_ACR_B_D_relab_prune <-subset_samples(Transplant_PS_ACR_lower_relab_prune, treated_analysis_group %in% c("group B", "group D")) ##Pruned phyloseq
#-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
#ddPCR read count
phyloseq_keep_ddPCR_ACR_B_D <-data.frame(sample_data(Transplant_PS_ACR_B_D)[,c("SampleID","treated_analysis_group")])
Total_ddPCR_ACR_B_D <- merge(Total_ddPCR, phyloseq_keep_ddPCR_ACR_B_D, by="SampleID") #keeping only the samples we care about (processed phyloseq)
##################Figure 2 A##################
read_count_KW(Total_ddPCR_ACR_B_D, "treated_analysis_group", 
              c("group B", "group D"), c("navyblue", "deeppink3"), 
              xlabel_size=14, ylabel_size=13, axis_title_size=15,
              p_value="yes", output="ddPCR_bronch_ACR_Grp_B_D", ylabel="Bacterial concentration (log10 copies per uL)", count_variable="ddPCR_count")

read_count_KW(Transplant_PS_ACR_B_D, "treated_analysis_group", 
              c("group B", "group D"), c("navyblue", "deeppink3"), 
              xlabel_size=14, ylabel_size=13, axis_title_size=15,
              p_value="yes", output="read_count_bronch_ACR_Grp_B_D")

##################Figure 2 B##################
alpha_diversity_KW(Transplant_PS_ACR_B_D, "treated_analysis_group", 
                   c("group B", "group D"), c("navyblue", "deeppink3"), 
                   xlabel_size=14, ylabel_size=13, axis_title_size=15,
                   p_value="yes", output="alpha_bronch_ACR_Grp_B_D")

##################Figure 2 C##################
beta_diversity_KW(Transplant_PS_ACR_B_D_relab, "treated_analysis_group", 
                  c("group B", "group D"), c("navyblue", "deeppink3"), 
                  p_value="yes", output="beta_bronch_ACR_Grp_B_D")

##################Figure 2 D##################
Edger_phylo_KW(Transplant_PS_ACR_B_D_prune, 
               variable_to_compare="treated_analysis_group",
               outcome_to_compare=c("group B", "group D"),
               outcome_to_compare_color=c("navyblue", "deeppink3"),
               FDR_cut_off=0.2,number_display=25,
               legend_onplot="yes",
               output_name="Edger_bronch_ACR_Grp_B_D",
               decontam="Contam_list_NC_BKG_compare_Lower_and_Upper_ACR")
